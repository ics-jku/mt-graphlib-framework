...
class FillEllipse(MTCGenerator):
    def __init__(self, path='', name="fillEllipse"):
        super(FillEllipse, self).__init__(path, name)

    def source_testcase(self, cpp):
        cpp(f"tft.fillEllipse({self.args['x']},{self.args['y']},{self.args['r']},{self.args['r']},{self.args['color_fg']});") 
