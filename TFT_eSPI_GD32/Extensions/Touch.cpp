...
/***************************************************************************************
** Function name:           setTouchRotation
** Description:             rotate the touch screen orientation. 
***************************************************************************************/
void TFT_eSPI::setTouchRotation(uint8_t rotation) {
    switch (rotation) {
        case 0:
            ...
            break;
        case 1:
            touchCalibration_rotate = 0;
            touchCalibration_invert_x = 0;
            touchCalibration_invert_y = 0;
            break;
        case 2:
            touchCalibration_rotate = 1;
            touchCalibration_invert_x = 0;
            touchCalibration_invert_y = 4;
            break;
        case 3:
            touchCalibration_rotate = 0;
            touchCalibration_invert_x = 2;
